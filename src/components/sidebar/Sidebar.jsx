    ...
    <div className="sidebar">
      <div className="sidebarWrapper">
        <div className="sidebarMenu">
          ...
          <ul className="sidebarList">
            <li className="sidebarListItem">
              <LoginIcon className="sidebarIcon" />Log In
            </li>
            <li className="sidebarListItem">
        ...
        <div className="sidebarMenu">
          ...
          <ul className="sidebarList">
            <li className="sidebarListItem">
              <FilePresentIcon className="sidebarIcon" />Your Trained Models
            </li>
            <li className="sidebarListItem">
              <AssignmentTurnedInIcon className="sidebarIcon"/> Your Tested Models
            </li>
